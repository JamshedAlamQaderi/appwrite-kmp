package com.jamshedalamqaderi.appwrite.kmp.cookies.stores

import com.jamshedalamqaderi.appwrite.kmp.extensions.fillDefaults
import com.jamshedalamqaderi.appwrite.kmp.extensions.fromJson
import com.jamshedalamqaderi.appwrite.kmp.extensions.matches
import com.jamshedalamqaderi.appwrite.kmp.extensions.toJson
import com.jamshedalamqaderi.appwrite.kmp.models.CookieCache
...
class CachedCookiesStorage : CookiesStorage {
    ...
    override suspend fun addCookie(
        ...
        mutex.withLock {
            ...
            container.add(
                CookieCache(
                    com.jamshedalamqaderi.appwrite.kmp.models.Cookie.from(
